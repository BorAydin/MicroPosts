...
function submitPost() {
  ...
  if (title === '' || body === '') {
    ...
    _ui.ui.showAlert('Lütfen alanları doldurun.', 'alert alert-danger');
  } else {
    ...
    if (id === '') {
      ...
      _http.http.post('http://localhost:3000/posts', data).then(function (data) {
        ...
        _ui.ui.showAlert('Post Eklendi.', 'alert alert-success');
      ...
      _http.http.put('http://localhost:3000/posts/' + id, data).then(function (data) {
        ...
        _ui.ui.showAlert('Post Güncellendi.', 'alert alert-success');
  ...
  if (e.target.parentElement.classList.contains('delete')) {
    ...
    if (confirm('Emin misin?')) {
      ...
      _http.http.delete('http://localhost:3000/posts/' + id).then(function (data) {
        ...
        _ui.ui.showAlert('Post Kaldırıldı.', 'alert alert-success');
        getPosts();
      }).catch(function (err) {
        return console.log(err);
      });
...
var http = exports.http = new CustomHTTP();
  ...
  _createClass(UI, [{
    ...
    value: function changeFormState(type) {
      ...
      if (type === 'edit') {
        ...
        this.postSubmit.textContent = 'Postu Güncelle';
        this.postSubmit.className = 'post-submit btn btn-warning btn-block';

        // İptal Butonu Oluşturma
        if (!document.querySelector('.post-cancel')) {

          var button = document.createElement('button');
          button.className = 'post-cancel btn btn-light btn-block';
          button.appendChild(document.createTextNode('İptal Et'));
        ...
        this.postSubmit.textContent = 'Gönder';
        this.postSubmit.className = 'post-submit btn btn-primary btn-block';

        // İptal Butonunu Kaldırma
        if (document.querySelector('.post-cancel')) {
          document.querySelector('.post-cancel').remove();
        }

        // Gizlenmiş Alandan Id'yi Silme
        this.clearIdInput();
